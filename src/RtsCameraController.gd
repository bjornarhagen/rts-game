...
########################
# Credits to https://github.com/IndieQuest for a lot of this
########################
...
var is_rotating_with_keyboard_x = false
var is_rotating_with_keyboard_y = false
var keyboard_rotation_direction = 0
# pan
...
func _input(event: InputEvent) -> void:
	...
	if event.is_action_released("camera_rotate_mouse"):
		is_rotating = false
	# rotation with keyboard
	if event.is_action_pressed("camera_rotate_left"):
		is_rotating = true
		is_rotating_with_keyboard_x = true
		keyboard_rotation_direction = 1
	if event.is_action_released("camera_rotate_left"):
		is_rotating = false
		is_rotating_with_keyboard_x = false
	...
	if event.is_action_released("camera_rotate_right"):
		is_rotating = false
		is_rotating_with_keyboard_x = false
	if event.is_action_pressed("camera_rotate_up"):
		is_rotating = true
		is_rotating_with_keyboard_y = true
		keyboard_rotation_direction = 1
	if event.is_action_released("camera_rotate_up"):
		is_rotating = false
		is_rotating_with_keyboard_y = false
	if event.is_action_pressed("camera_rotate_down"):
		is_rotating = true
		is_rotating_with_keyboard_y = true
		keyboard_rotation_direction = -1
	if event.is_action_released("camera_rotate_down"):
		is_rotating = false
		is_rotating_with_keyboard_y = false
	# pan
...
func _rotate_and_elevate(delta: float) -> void:
	...
	if is_rotating_with_keyboard_x:
		_rotate(rotation_speed * keyboard_rotation_direction, delta)
	if is_rotating_with_keyboard_y:
		_elevate(rotation_speed * keyboard_rotation_direction, delta)
